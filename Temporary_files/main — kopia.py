...
############################
### na dole działający kod przed  komentarzami
################################################
...
###################
### u góry działający kod przed komentarzami
###################################################
# curl -Method POST `
#      -Uri "http://127.0.0.1:8000/actors" `
#      -Headers @{ "Content-Type" = "application/json" } `
#      -Body '{ "name": "xxxxxx", "surname": "Reeves" }'

# Invoke-RestMethod -Uri "http://127.0.0.1:8000/actors" -Method POST -Body '{"name":"test","surname":"Reeves"}' -ContentType "application/json"
